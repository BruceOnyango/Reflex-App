...
Revision ID: 0bf2fcd3628d
Revises: 
Create Date: 2024-08-15 20:50:22.108439
...
def upgrade() -> None:
    ...
    sa.Column('expiration', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
